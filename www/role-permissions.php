...
<body>
	...
	<!-- Update permissions of a role : Controller -->
	<?php
					...
					if (isset($_POST['updateRole'])) {	
						...
						if ($role){
							...
							if (!$perm_id){
								...
								$genericUpdateSuccess = "Rôle mise à jour (".$title.")";	
							}
						}
					}
				}
	...
	<!-- Update permissions of a role : display form -->
	<div class="container">
		<?php
		...
		<h2>Modifier les permissions d'un rôle</h2>
		<form class="form-horizontal" action='role-edit.php' method='post' accept-charset='utf-8'>
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					<h3 class="panel-title">Rôle : <?php echo $title;?></h3>
				</div>
				<div class="panel-body">
					Ce rôle a <?php 
						$rbac = new PhpRbac\Rbac();
						$count = count($rbac->Roles->permissions($id));
						echo $count;
					?> permissions.
